...
read varnode
varpathlog='/var/log/evaminer$varnode'
varpathnode='miner$varnode'
...
echo -e "Creating EVAMiner Service Log dir and files\n\n"
...
git clone https://github.com/Evanesco-Labs/go-evanesco.git $varpathnode
cd $varpathnode
make
